...
function Register() {
  ...
  return (
    <div style={{
      ...
      {/* Background glows */}
      <div style={{ position: 'absolute', width: '350px', height: '350px', borderRadius: '50%', background: 'rgba(233,69,96,0.1)', top: '-80px', left: '-80px', filter: 'blur(60px)' }} />
      <div style={{ position: 'absolute', width: '300px', height: '300px', borderRadius: '50%', background: 'rgba(69,183,209,0.08)', bottom: '-60px', right: '-60px', filter: 'blur(60px)' }} />
      <div style={{ position: 'absolute', width: '200px', height: '200px', borderRadius: '50%', background: 'rgba(150,206,180,0.07)', top: '50%', left: '70%', filter: 'blur(40px)' }} />
      ...
      <div style={{ position: 'absolute', fontSize: '30px', top: '45%', left: '3%', opacity: 0.1 }}>🚀</div>
      ...
      <div style={{
        ...
        <h2 style={{ color: '#e94560', textAlign: 'center', marginBottom: '25px', fontSize: '22px', fontWeight: '700' }}>Create Account</h2>
